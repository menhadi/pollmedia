...
The [official 1967 Lok Sabha Vol I/II report](https://old.eci.gov.in/files/file/4114-general-election-1967-vol-i-ii/) visibly clips or overprints the detailed candidate/party/vote rows for New Delhi and South Delhi on Vol I PDF page 187. Both records remain `needs_review` with no extracted candidate rows. Vol II PDF pages 499–500 independently preserve each constituency's winner/runner summary and aggregate vote figures, but those summaries do not reconstruct the missing full candidate tables. No detailed candidate votes have been inferred from the displayed percentages or totals.

The preserved by-election crawl records 96 distinct failed official detail-page downloads: 10 linked from February 1997, 23 from February 1998, 49 from June 1998, 13 from November 1998, and one from the 2007–08 index. The three 1998 index HTML pages and the 2007–08 index page are preserved, but their state/constituency lists contain no candidate or vote results; they are classified as source navigation, not result tables. The February 1997 and 2007–08 editions also retain 27 and 44 successfully collected source files, respectively. The ECI catalogue lists Dec 2009, Jan 2010 and November 2010 without downloadable links; their catalogue entries are retained as missing-official-link gaps. These counts describe this collection attempt and do not prove that no other official copy exists.

The 2007–08 [official index](https://old.eci.gov.in/ByeElection/07to08/bye07_08.htm) labels its missing PC detail link `10-THANE` (Maharashtra). That [linked detail page](https://old.eci.gov.in/ByeElection/07to08/pc/bye_10mh.htm) returned HTTP 404 on 25 September 2026 while the index returned HTTP 200. No Thane candidate or vote result has been inferred from the navigation entry.

The 24 September polling-index audit found 30,837 document references but only 16,986 distinct source-file SHA-256 hashes. Of those hashes, 9,333 occur under more than one state-directory label, accounting for 23,184 references. The largest overlap is between Madhya Pradesh and NCT of Delhi (4,813 hashes); other overlaps also include Bihar, Tamil Nadu and more states. For example, the same Haryana CEO Form 20 PDF (`f14afad8e6f8d932df4dfa4595fa59bcaad023e8d05c5f53c862d22bbe39cd99`) is indexed under Haryana, Madhya Pradesh and NCT of Delhi, with the same Haryana official URL. These are preserved collection references, not separate elections or evidence of jurisdiction in every labelled state. State totals in this source index must therefore not be used as unique state coverage counts until document-level jurisdiction is verified from the official source. The originals and URLs remain preserved; no vote totals or jurisdictions were inferred from directory names.
