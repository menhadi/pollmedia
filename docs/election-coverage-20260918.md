...
The preserved by-election crawl records 86 failed official detail-page downloads: 23 linked from the February 1998 index, 49 from June 1998, 13 from November 1998, and one from the 2007–08 index. The three 1998 index HTML pages and the 2007–08 index page are preserved, but their state/constituency lists contain no candidate or vote results; they are classified as source navigation, not result tables. The linked failures remain historical result gaps. The 2007–08 edition also retains 44 successfully collected source files. These counts describe this collection attempt and do not prove that no other official copy exists.
