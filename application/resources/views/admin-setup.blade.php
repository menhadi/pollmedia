...
<div class="field"><label for="password">Password</label><input style="width:100%" id="password" type="password" name="password" autocomplete="new-password" required minlength="12" maxlength="128"><small class="muted">Use at least 12 characters. A long, unique passphrase works well.</small></div>
<div class="field"><label for="password_confirmation">Confirm password</label><input style="width:100%" id="password_confirmation" type="password" name="password_confirmation" autocomplete="new-password" required minlength="12" maxlength="128"></div><button>Create administrator and sign in</button></form></div>
@endsection
