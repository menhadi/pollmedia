...
.dashboard-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:18px}.dashboard-grid .card{margin-bottom:0}header{flex-wrap:wrap}</style><link rel="stylesheet" href="/css/admin-shell.css?v={{ substr(hash_file('sha256', public_path('css/admin-shell.css')), 0, 12) }}"></head><body class="@auth admin-shell @endauth">
