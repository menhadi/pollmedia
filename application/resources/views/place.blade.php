...
</style><link rel="stylesheet" href="/css/election-dashboard.css?v={{ substr(hash_file('sha256', public_path('css/election-dashboard.css')), 0, 12) }}"></head><body class="election-ui">@include('public-header')<div class="dashboard-shell {{ in_array($place->type,['pc','ac']) ? '' : 'page-without-sidebar' }}"><main class="dashboard-main">
