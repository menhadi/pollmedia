@extends('seo-layout')
@section('content')
<div style="max-width:520px;margin:auto"><p class="muted">POLLMEDIA ADMINISTRATION</p><h1>Sign in</h1><p>Use your administrator account to manage official data, review updates and maintain page metadata.</p>
...
<div class="field"><label for="password">Password</label><input style="width:100%" id="password" type="password" name="password" autocomplete="current-password" required></div><button>Sign in</button></form>
@if($canSetup)
